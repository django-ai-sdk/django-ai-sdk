...
Each operation checks the user's permission via the agent's `permissions` classes and raises `PermissionDenied` when access is denied. See the [Views and Routing guide](/docs/views-and-routing/).
