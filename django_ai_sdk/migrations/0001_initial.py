# Generated by Django 6.0.6 on 2026-07-06 21:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["is_hidden"], name="django_ai_s_is_hidd_edc533_idx"),
                    models.Index(fields=["is_public"], name="django_ai_s_is_publ_ddb969_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="runs",
                to="django_ai_sdk.workflowsettings",
            ),
        ),
        migrations.CreateModel(
            name="AssistantGroup",
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="django_ai_sdk.assistantsettings",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="message",
            index=models.Index(
                fields=["thread", "created_at", "is_deleted"], name="django_ai_s_thread__6fd6b9_idx"
            ),
        ),
        migrations.AddIndex(
